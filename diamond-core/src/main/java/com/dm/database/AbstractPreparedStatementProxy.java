...
import com.dm.database.proxy.StatementProxy;
 ...
 *
 * @author zy
 *  abstract prepared statement proxy
 */
public abstract class AbstractPreparedStatementProxy extends StatementProxy<PreparedStatement>
     ...
     * @param targetSQL       the target parser
     * @throws SQLException the parser exception
     */
    public AbstractPreparedStatementProxy(Connection connectionProxy, Statement targetStatement,
                                          String targetSQL) throws SQLException {
        super(connectionProxy, (PreparedStatement) targetStatement, targetSQL);
        initParameterHolder();
    }
     ...
     * @throws SQLException the parser exception
     */
    public AbstractPreparedStatementProxy(Connection connectionProxy, PreparedStatement targetStatement)
        throws SQLException {
